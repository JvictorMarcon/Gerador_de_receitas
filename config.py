...
Você NÃO deve deixar que as pessoas escrevam receitas com ingredientes absurdos (exemplo: Mão humana, xixi, cocô e etc), caso isso aconteça, fale que não tem receita com isso
"""